...
2. 循环转到**哪一圈**了（决定仓位纪律）？
3. **增量资金**还在流入吗、**潜在抛压**（质押 / 解禁 / 大宗折价）在积累吗？
...
| `FB_long` | 正反馈增量资金 | 还有多少新资金在流入（融资/游资/换手/回购增持） |
| `FB_neg` | 负反馈脆弱度 | 潜在抛压：高质押、大额解禁、大宗折价出货 |
| `VolDiv` | 量价顶背离强度 | 价格仍在创新高，但成交量已萎缩，买盘不足 |
